/*
	1: PVDZE_maintainArea = [player,1,[[Object, _objectID, _objectUID],[Object, _objectID, _objectUID]...и т.д.]];
...
if (_option == 1) then
{
	...
	diag_log format ["[СЕРВЕР] - [server_maintainArea.sqf]: ТЕРРИТОРИЯ: Игрок: %1 - %2 Объектов: %3", _name, (count _objectsInfo), (getPosATL _player)];
}
else
{

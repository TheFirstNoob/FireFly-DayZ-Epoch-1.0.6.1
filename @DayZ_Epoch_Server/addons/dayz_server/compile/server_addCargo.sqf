/*
	Добавляет груз к объекту
	
	Параметр: 
	_this select 0: массив - Оружие груз для добавления
	_this select 1: массив - Магазин груз для добавления
	_this select 2: массив - Рюкзак груз для добавления
	_this select 3: объект - Объект груз для добавления
*/

...
//diag_log ("HIVE: Menu Request by ClientID: "+ str(_clientID));	// Позже
...
if(isNil "_retrader") then
{
	...
	//diag_log "HIVE: Request sent";	// Позже
	...
	if (_status == "ObjectStreamStart") then {
		...
		// Обрабатываем
		//diag_log ("HIVE: Commence Menu Streaming...");	// Позже
		...
		//diag_log ("HIVE: Streamed " + str(_val) + " objects");	// Позже
		
	};
};

// diag_log(_retrader); 	// Позже
